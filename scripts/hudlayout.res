"Resource/HudLayout.res"
{
	...
	// xPloitHUD Custom Stuff
	
	"Transparent-xPloit" // Makes Sniper's Scope Transparent (and weapons)
	{
		"ControlName"	"CTFImagePanel"
		"fieldName"		"Transparent-xPloit"
		"xpos"			"0"
		"ypos"			"0"
		"zpos"			"-1"		
		"wide"			"f0"
